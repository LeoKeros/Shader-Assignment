...
bool CSceneManager::CreateStates()
{
	//--------------------------------------------------------------------------------------
	// Texture Samplers
	//--------------------------------------------------------------------------------------
	...
	blendDesc.RenderTarget[0].SrcBlend = D3D11_BLEND_ZERO;      // How to blend the source (texture colour) - See lab notes
...
void CSceneManager::ReleaseStates()
{
	...
	if (gMultiplicativeBlending)  gMultiplicativeBlending->Release();
